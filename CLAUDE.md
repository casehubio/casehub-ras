...
| `testing/` | `casehub-ras-testing` | `io.casehub.ras.testing` | MockGanglion, FixedDetectionResult. **Test scope only.** |
...
validation only. A situation instance is identified by the tuple `(situationId, tenancyId)`.
