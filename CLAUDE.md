...
| `GanglionOutcomeStatistics` | Per-ganglion aggregate — `ganglionId`, `totalOutcomes`, `noiseCount`, `confirmedCount`, `neutralCount`. Implements `QualityMetrics`. Only counts positive-signal (DETECTED/WEAK) contributions. |
